...
export function getDashboardFixtureRecords() {
  ...
  return [
    ...
    {
      leadId: 'fixture_started',
      status: 'started',
      commercialStatus: '',
      createdAt: iso(4),
      updatedAt: iso(1),
      formData: { nome: 'César Lima', empresa: 'Zeta Comércio', email: 'cesar@zeta.com', whatsapp: '(31) 98888-2222', faturamento: 'R$1M-R$5M/ano', localizacao: 'Belo Horizonte, MG' },
    },
    {
      leadId: 'fixture_captured_2',
      status: 'captured',
      commercialStatus: '',
      createdAt: iso(3),
      updatedAt: iso(3),
      formData: { nome: 'Diana Prado', empresa: 'Eta Digital', email: 'diana@eta.com', whatsapp: '(51) 97777-3333', faturamento: 'R$5M-R$20M/ano', localizacao: 'Porto Alegre, RS' },
    },
    {
      leadId: 'fixture_completed_warm',
      status: 'completed',
      commercialStatus: '',
      createdAt: iso(80),
      updatedAt: iso(10),
      completedAt: iso(36),
      formData: { nome: 'Felipe Nunes', empresa: 'Theta Labs', email: 'felipe@theta.com', whatsapp: '(11) 96666-4444', faturamento: 'R$1M-R$5M/ano', localizacao: 'São Paulo, SP' },
      report: { ...report, score_geral: 52, nome: 'Felipe Nunes', empresa: 'Theta Labs' },
      conversation,
    },
    {
      leadId: 'fixture_reuniao',
      status: 'completed',
      commercialStatus: '',
      pipelineStage: 'reuniao_diagnostico',
      pipelineStageAt: iso(5),
      createdAt: iso(60),
      updatedAt: iso(5),
      completedAt: iso(20),
      formData: { nome: 'Giovana Reis', empresa: 'Iota Consult', email: 'gio@iota.com', whatsapp: '(19) 95555-5555', faturamento: 'R$5M-R$20M/ano', localizacao: 'Campinas, SP' },
      report: { ...report, score_geral: 61, nome: 'Giovana Reis', empresa: 'Iota Consult' },
      conversation,
    },
    {
      leadId: 'fixture_won',
