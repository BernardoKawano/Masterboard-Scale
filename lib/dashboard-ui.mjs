...
export function buildFilterBannerHtml(message = 'Filtros da aba Leads estão ativos. Os números abaixo refletem só o recorte atual.') {
  return `<div class="filter-banner">${escapeAttr(message)} <button class="icon" data-empty-action="clear" type="button">Limpar filtros</button></div>`;
}
